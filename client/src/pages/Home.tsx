...
const ASSETS = {
  logo: "/assets/automatizenow-logo.webp",
  hero: "/assets/hero-visual.webp",
  network: "/assets/network-visual.webp",
  chat: "/assets/showcase-chat.webp",
  dashboard: "/assets/showcase-dashboard.webp",
  flow: "/assets/showcase-flow.webp",
  team: "/assets/team-workflow.webp",
  architecture: "/assets/system-architecture.webp",
};
      ...
      <section className="calculator" id="calculadora">
        <div className="container calculator-grid">
          ...
          <div className="calculator-panel reveal">
            ...
            <div className="savings-stage"><div className="savings-board manual-board"><b>A mano</b><small>Como se ha hecho siempre</small><span>Responder emails <i>10:42</i></span><span>Revisar datos <i>13:16</i></span><span>Actualizar CRM <i>16:20</i></span></div><div className="savings-clock" aria-label={`Ahorro estimado de ${savings.hours} horas al mes`}><div className="clock-ring">{Array.from({ length: 12 }, (_, index) => <span className="clock-tick" style={{ transform: `rotate(${index * 30}deg)` }} key={index} />)}<span className="clock-hand" /><span className="clock-center" /></div><strong>{savings.hours} h</strong><small>recuperadas / mes</small></div><div className="savings-board auto-board"><b>Con AutomatizeNow</b><small>Lo que puede hacer tu sistema</small><span>Responder emails <i>09:18</i></span><span>Revisar datos <i>09:48</i></span><span>Actualizar CRM <i>10:11</i></span></div></div>
