...
const ASSETS = {
  logo: "/assets/automatizenow-logo.png",
  hero: "/assets/hero-visual.png",
  network: "/assets/network-visual.png",
  chat: "/assets/showcase-chat.png",
  dashboard: "/assets/showcase-dashboard.png",
  flow: "/assets/showcase-flow.png",
  team: "/assets/team-workflow.jpg",
